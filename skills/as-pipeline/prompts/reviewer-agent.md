...
3. Find ALL real issues across these dimensions: AC coverage, task completion, code quality, security vulnerabilities, architecture compliance (compare to architecture-design.md), test quality (are tests meaningful or just smoke?). Do not manufacture issues — only report genuine problems.
