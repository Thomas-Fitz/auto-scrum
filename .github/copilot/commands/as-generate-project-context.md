...
allowed-tools: [ReadFile, WriteFile, CreateDirectory, FindFiles, ListDirectory, RunTerminalCommand]
---
...
```markdown
# Project Context
_Generated by /as-generate-project-context. Regenerate with /as-generate-project-context or edit manually._
